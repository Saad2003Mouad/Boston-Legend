  ...
  try {
    ...
    const newPkg = await prisma.package.create({
      data: {
        ...
        imageUrl: data.imageUrl || data.image || "https://cdn.prod.website-files.com/67dc601bc29781a5af1632a2/67dc601bc29781a5af163351_image-01-products-boston-legend-ice-cream-truck.webp",
