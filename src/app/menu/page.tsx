...
export const metadata: Metadata = constructMetadata({
  title: "Ice Cream Menu | American Legend Ice Cream Truck",
  description:
...
const faqs = [
  {
    question: "What makes American Legend Ice Cream different?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Absolutely! While our menu highlights our most popular classic and premium options, our trucks can be stocked with specific favorites tailored for your guests. Just let our American Legend concierge know your preferences when booking.",
  },
  {
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-32 overflow-hidden bg-cream">
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 relative z-10 text-center">
          ...
          <p className="font-sans font-medium text-lg sm:text-xl md:text-2xl text-charcoal/70 max-w-3xl mx-auto leading-relaxed drop-shadow-sm">
            Experience our meticulously curated selection of premium artisan treats and nostalgic ice cream novelties. Perfect for any celebration across New England.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
            {menuItems.map((item) => (
              <Link href={`/menu/${item.slug}`} key={item.id}>
                <div className="group bg-[#FFFDF8] p-3 sm:p-4 md:p-5 rounded-2xl sm:rounded-3xl border border-navy/5 hover:border-coral/40 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col h-full cursor-pointer">
                  {item.image && (
